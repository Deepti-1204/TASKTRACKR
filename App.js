...
function App() {
  ...
  return (
    <div className="container">
      <h3 align="center">Deepti's To-Do App</h3>
      ...
      <div className="filter-buttons">
        ...
        <button id="donebtn" onClick={() => setFilter('Done')}>
          Done
        </button>
        <button id="todobtn" onClick={() => setFilter('Todo')}>
          Todo
        </button>
      </div>
      <ul>
          ...
          <li key={todo._id}>
            {editingTodo === todo._id ? (
              <>
                ...
                />
                <button id="save" onClick={saveEdit}>
                  Save
                </button>
              </>
            ) : (
              <>
                ...
                <div>
                  ...
                  />
                  <button id="edit" onClick={() => startEditing(todo)}>
                    ✏️
                  </button>
                  <button id="del" onClick={() => deleteTodo(todo._id)}>
                    🗑️
                  </button>
                </div>
              </>
